...
class FollowsFunction implements ExternalFunction {

	private ArgumentType[] argTypes = new ArgumentType[]{ArgumentType.UniqueID, ArgumentType.UniqueID, ArgumentType.UniqueID};//.Integer,ArgumentType.Integer,	// x-coord
	...
	public FollowsFunction(int maxIncrement) {
	...
	public double getValue(ReadOnlyDatabase db, GroundTerm... args) {
		...
		//System.out.println("Follows evaluated to: "+follows);
