...
class FollowsFunction5 implements ExternalFunction {

	private ArgumentType[] argTypes = new ArgumentType[]{ArgumentType.UniqueID, ArgumentType.UniqueID, ArgumentType.UniqueID, ArgumentType.UniqueID, ArgumentType.UniqueID};		
	private int maxIncrement;
	private static final ArrayList<Integer> timestamps = new ArrayList<Integer>();
	
	public FollowsFunction5(int maxIncrement) {
