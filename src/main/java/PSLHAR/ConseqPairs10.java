...
class ConseqPairs10 implements ExternalFunction {

	private ArgumentType[] argTypes = new ArgumentType[]{ArgumentType.UniqueID, ArgumentType.UniqueID, ArgumentType.UniqueID, ArgumentType.UniqueID, ArgumentType.UniqueID, ArgumentType.UniqueID, ArgumentType.UniqueID,ArgumentType.UniqueID, ArgumentType.UniqueID, ArgumentType.UniqueID};		
	private int maxIncrement;
	private static final ArrayList<Integer> timestamps = new ArrayList<Integer>();
	
	public ConseqPairs10(int maxIncrement) {
	...
	public double getValue(ReadOnlyDatabase db, GroundTerm... args) {
		...
		try{
            ...
            System.err.println("Error in ConseqPairs10: " + e.getMessage());
        }
